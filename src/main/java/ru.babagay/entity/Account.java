...
public class Account implements DomainObject {
    ...
    public Account(long id, String login, String password, String first_name, String last_name, String middle_name, String email, boolean active, String created, String updated, boolean deleted) {
        this.id = id;
        this.login = login;
